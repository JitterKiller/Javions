...
public final class SamplesDecoder {
     ...
     *          si la taille de lot n'est pas strictement positive (on utilise la méthode checkArgument()).
     * @throws NullPointerException
     *          si le flot d'entrée est nul (on utilise la méthode requireNonNull()).
     */
     ...
     * @param batch
     *          le tableau d'échantillons qui doit être rempli.
     * @return  le nombre d'échantillons convertis dans le tableau fourni (batch).
     * @throws IOException
     *          si une erreur se produit lors de la lecture des octets à partir du flux d'entrée.
     * @throws IllegalArgumentException
     *          si la longueur du tableau d'échantillons fourni ne correspond pas à la
