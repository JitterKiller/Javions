...
public class CprDecoder {
     ...
     * @param x0
     *          La longitude locale (normalisée) d'un message pair.
     * @param y0
     *          La latitude locale (normalisée) d'un message pair.
     * @param x1
     *          La longitude locale (normalisée) d'un message impair.
     * @param y1
     *          La latitude locale (normalisée) d'un message impair.
     * @param mostRecent
     *          l'index du message le plus récent (0 pour pair, 1 pour impair).
     ...
     *          si l'index du message le plus récent (mostRecent) n'est pas égal à 0 ou 1.
     */
     ...
     *          la longitude de l'aéronef en degrés.
     * @param latitudeDegree
     *          la latitude de l'aéronef en degrés.
     ...
     * @param coordinate
     *          La longitude/latitude à recentrer.
